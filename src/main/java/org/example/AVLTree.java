...
class AVLTree {
    ...
    public static void main(String[] args) throws IOException {
        ...
        tree.printTree(tree.root, "", true);
        FileWriter fw = new FileWriter("TreeDatabase.dat");
        AVLTree TreeDat[] = { tree };
        int TreeInput[] = { TreeNum1, TreeNum2, TreeNum3, TreeNum4, TreeNum5, TreeNum6, TreeNum7, TreeNum8 };

        for (int i = 0; i < TreeDat.length; i++) {
            fw.write(tree + "\n");
            fw.write("Inputted Numbers: " + TreeNum1 + ", " + TreeNum2 + ", " + TreeNum3 + ", " + TreeNum4 + ", " + TreeNum5 + ", " + TreeNum6 + ", " + TreeNum7 + ", " + TreeNum8);
        }
        fw.close();
        TreeScanner.close();
    }
